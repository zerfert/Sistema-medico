...
<?php
    ...
    if ($resultado->num_rows>0) {
    	echo "<table border=1 class='tabla_datos'>
    			<thead>
                <th>Identificacion</th><th>Nombre</th><th>Medico</th><th>Especialidad</th><th>Fecha</th><th>Hora</th><th>Observaciones</th><th>Estado del la cita</th><th>Eliminar</th><th>Editar</th>
    	...
    	while ($fila = $resultado->fetch_assoc()) {
    		echo "<tr>
						...
						<td>".$fila['estado']."</td>";
						?>
						<td align="center"><a href="javascript:void(0);" onClick="eliminar('elic.php?u=<?php echo $fila['id_i'];?>');" title="Eliminar Registros"><img src="../../img/elim.png" width="25" height="25">
						</a></td>
						<td><a href="javascript:void(0);" onclick="window.location='edici.php?u=<?php echo $fila['id_i']?>'" title="Editar Registros"><img src="../../img/edit.png" width="25" height="25"></a>
						</td>
						</tr>
						<?php 
